...
switch ($post_meta){
    case "pm":
        $quantity_desc = '<div class="metres-requried">Please enter number of metres required:</div>';
        break;
    case "pr100":
        $quantity_desc = '<div class="metres-requried">Please enter number of 100m reels required:</div>';
        break;
    case "pr500":
        $quantity_desc = '<div class="metres-requried">Please enter number of 500m reels required:</div>';
        break;
}
